...
const COLOR_FALLBACKS: Record<string, Record<number, string>> = {
...
const DARK_SHADE_MAP: Record<number, number> = {
    0: 950, 50: 900, 100: 800, 200: 700, 300: 600, 400: 500,
    500: 400, 600: 300, 700: 200, 800: 100, 900: 50, 950: 0,
};
...
export const useColors = () => {
    ...
    return useMemo(() => {
        const getThemeColor = (prefix: string, shade: number) => {
            ...
            return getColor(defaultTheme, colorKey) || COLOR_FALLBACKS[prefix]?.[targetShade] || COLOR_FALLBACKS[prefix]?.[shade] || "";
        };
