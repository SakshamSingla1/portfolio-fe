...
const ServiceListingPage: React.FC = () => {
    ...
    return (
        <div>
            <LogoTableTemplate logos={logos} pagination={pagination} handleFiltersChange={handleFiltersChange} handlePaginationChange={handlePaginationChange} handleRowsPerPageChange={handleRowsPerPageChange} filters={filters} />
        </div>
    )
}
