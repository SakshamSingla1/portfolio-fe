...
import { type Logo, type LogoFilterParams } from '../../../services/useLogoService';
...
interface LogoTableTemplateProps {
    ...
    filters: LogoFilterParams;
}

const LogoTableTemplate: React.FC<LogoTableTemplateProps> = ({ logos, pagination, handleFiltersChange, handlePaginationChange, handleRowsPerPageChange, filters }) => {
