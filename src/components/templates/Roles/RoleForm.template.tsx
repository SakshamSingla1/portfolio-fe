...
const RoleFormTemplate: React.FC<RoleFormTemplateProps> = ({ roleDetails, mode, onSubmit }) => {
    ...
    const [expandedNavlinks, setExpandedNavlinks] = useState<Set<any>>(new Set());
    ...
    const areAllPermissionsSelected = (navLinkId: any) => {
    ...
    const toggleNavlinkExpansion = (navlinkId: any) => {
    ...
    const getNavlinkSelectionStats = (navlinkId: any) => {
